...
if len(user_phone_num) > 10:
    st.warning("Invalid number, >10 numbers")
user_phone_num = f"+1{user_phone_num}"  # add +1
...
if user_meth_bool == "Add":
    ...
    add_notif_bool = col1.button("Request Notifications")

if user_meth_bool == "Remove":
    rem_botif_bool = col1.button("Remove Notifications")
